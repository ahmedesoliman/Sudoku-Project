...
function getRow (puzzle, rowIdx) {
  if (Array.isArray(puzzle) === true) {
     sudokuRow.push(puzzle[rowIdx]) 
  }
  return sudokuRow;
}
// getRow (puzzle, 1)
...
function getColumn (puzzle, columnNum) {
  for(let i = 0; i < puzzle.length; i++){
    sudokuCol.push(puzzle[i][columnNum]);
  }
  return sudokuCol;
}
// getColumn (puzzle, 0)
...
var arrayCheck = [1, 2, 3, 4, 5, 6, 7, 8, 9]

function includes1to9(array) {
  arrayCheck[0][1][2][3][4][5][6][7][8].includes();
}
